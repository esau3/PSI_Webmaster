...
async function createPages() {
  ...
  await Promise.all([
    pageCreate(0, "https://www.netflix.com/home", new Date(), randomState()),
    pageCreate(1, "https://www.netflix.com/browse", new Date(), randomState()),
    pageCreate(2, "https://www.netflix.com/search", new Date(), randomState()),
    pageCreate(3, "https://ciencias.ulisboa.pt/home", new Date(), randomState()),
    pageCreate(4, "https://ciencias.ulisboa.pt/cursos", new Date(), randomState()),
    pageCreate(5, "https://ciencias.ulisboa.pt/investigacao", new Date(), randomState()),
    pageCreate(6, "https://fenix.ciencias.ulisboa.pt/home", new Date(), randomState()),
    pageCreate(7, "https://fenix.ciencias.ulisboa.pt/turmas", new Date(), randomState()),
    pageCreate(8, "https://fenix.ciencias.ulisboa.pt/avaliacoes", new Date(), randomState()),
    pageCreate(9, "https://www.amazon.com/home", new Date(), randomState()),
    pageCreate(10, "https://www.amazon.com/categories", new Date(), randomState()),
    pageCreate(11, "https://www.amazon.com/account", new Date(), randomState()),
    pageCreate(12, "https://www.olx.pt/home", new Date(), randomState()),
    pageCreate(12, "https://www.olx.pt/ads", new Date(), randomState()),
    pageCreate(12, "https://www.olx.pt/account", new Date(), randomState()),
    pageCreate(15, "https://www.wikipedia.org/main", new Date(), randomState()),
    pageCreate(16, "https://www.wikipedia.org/random", new Date(), randomState()),
    pageCreate(17, "https://www.wikipedia.org/recent", new Date(), randomState()),
    pageCreate(18, "https://www.google.com/search", new Date(), randomState()),
    pageCreate(19, "https://www.google.com/maps", new Date(), randomState()),
    pageCreate(20, "https://www.google.com/gmail", new Date(), randomState()),
    pageCreate(21, "https://www.youtube.com/home", new Date(), randomState()),
    pageCreate(22, "https://www.youtube.com/trending", new Date(), randomState()),
    pageCreate(23, "https://www.youtube.com/subscriptions", new Date(), randomState()),
    pageCreate(24, "https://www.facebook.com/home", new Date(), randomState()),
    pageCreate(25, "https://www.facebook.com/profile", new Date(), randomState()),
    pageCreate(26, "https://www.facebook.com/friends", new Date(), randomState()),
    pageCreate(27, "https://twitter.com/home", new Date(), randomState()),
    pageCreate(28, "https://twitter.com/explore", new Date(), randomState()),
    pageCreate(29, "https://twitter.com/notifications", new Date(), randomState()),
  ]);
}
